...
async function main() {
  ...
  const recipient1 = process.env.RECIPIENT_ADDRESS;
  const recipient2 = process.env.RECIPIENT_ADDRESS2;
  ...
  const calls = [
    ...
    abi: erc20TransferAbi,
    functionName: "transfer",
    args: [recipient2, amountWei],
  })}];

  console.log("Safe account:", safeAccount.address);
  console.log("Sending USDC:", amountHuman, "USDC ->", recipient1, "and", recipient2);
